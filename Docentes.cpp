#include "Docentes.h"
/*
Docentes::Docentes (int cod, string nom, string email, string url, string passwd, iDictionary asignaturas, iCollection clases, string nombre_Instituto) : Usuarios(cod,nom, email, url, passwd, asignaturas, clases){
